  ...
  : LifecycleNode("emcl2_node", "", options)
{
  ...
  if (!this->has_parameter("range_threshold")) {
    rcl_interfaces::msg::ParameterDescriptor descriptor;
    descriptor.type = rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE;
    descriptor.description = "threshold of the range of lasers; if all lasers on this range penetrate occupancy cells, the pose of the particle is judged as wrong [rad]";
